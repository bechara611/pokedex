        ...
        <>
            ...
            {pokemonActivo?.sprites?.back_default ?
                ...
                <div className="contenedor-detalle ">
                    ...
                    <div className="col-6 contenedor-general-sprites">
                        <div className="row ">
                            <div className="col-12 contenedor-sprites">
                                <CardPoke2 className='izquierda' type={'Back'} sprite={pokemonActivo?.sprites?.back_default}></CardPoke2>
                                <CardPoke2 className='izquierda' type={'Back'} sprite={pokemonActivo?.sprites?.back_shiny}></CardPoke2>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-12 contenedor-sprites">
                                <CardPoke2 type={'Back'} sprite={pokemonActivo?.sprites?.front_default}></CardPoke2>
                                <CardPoke2 type={'Back'} sprite={pokemonActivo?.sprites?.front_shiny}></CardPoke2>
                            </div>
                        </div>
                    </div>
