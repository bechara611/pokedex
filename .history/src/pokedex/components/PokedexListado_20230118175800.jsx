    ...
    return (
        <>
            ...
            <div className="col-12 contenedor-listado ">
                ...
                {
                    vectorPokemonesCompletado.length==0 ? <><h1>NO DATA</h1></>:
                    
                    vectorPokemonesCompletado.map((pokemon, index) => {
                        
                    return <img key={index} src="https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/10128.png"
                    className='col-xl-1 col-md-2 col-3 imagenPokemon '
