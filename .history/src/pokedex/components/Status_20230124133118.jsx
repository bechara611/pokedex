                    ...
                    return (
                            ...
                            <div className="col-12 contenedor-barra" key={index}>
                                ...
                                <div className="col-12 bg-info">  <p className='nombre-status'>{objeto[key].stat.name}</p></div>
                                    <div className= {`progress-bar bg-info ${obtenerClase(objeto[key].stat.name)}`} role="progressbar" style={{ width: "100%" }} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
