                    ...
                    <div className="col-6 contenedor-general-sprites">
                        <div className="row ">
                            <div className="col-12 contenedor-sprites">
                                <div><CardPoke2 className='' type={'Back'} sprite={pokemonActivo?.sprites?.back_default}></CardPoke2></div>
                                <CardPoke2 className='' type={'Back'} sprite={pokemonActivo?.sprites?.back_shiny}></CardPoke2>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-12 contenedor-sprites">
