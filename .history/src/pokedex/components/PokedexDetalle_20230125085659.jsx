                    ...
                    <div className="row">
                        <div className="col-12 cuadro1">
                            ...
                            <p className='NombreTipos'> 
                                <span className='type-item' style={{ background: obtenerClase(pokemonActivo?.types[0]?.type.name), padding:'5px' }}>{pokemonActivo.types[0].type.name}</span>
                                {
                                    pokemonActivo.types.length>1 &&    <span className='type-item' style={{ background: obtenerClase(pokemonActivo?.types[1]?.type.name),padding:'5px', marginRight:'-20px'  } }>{pokemonActivo?.types[1]?.type.name}</span>
