...
export const PokedexDetalle = () => {
    ...
    useEffect(() => {
        ...
        if (pokemonActivo) { console.log(pokemonActivo.types[0].type) } else { console.log('no tiene') }
                    ...
                    <div className="row">
                        <div className="col-12 cuadro1">
                            ...
                            <p className='NombreTipos'> {`Type: `}
                                ...
                                {
                                    pokemonActivo.types.length>0 &&    <span className='type-item' style={{ background: 'purple' }}>{pokemonActivo.types[1].type.name}</span>
