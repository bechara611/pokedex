...
export const PokedexDetalle = () => {
    ...
    useEffect(() => {
        ...
        if (pokemonActivo) { console.log(obtenerClase(pokemonActivo?.types[1]?.type.name)) } else { console.log('no tiene') }
                ...
                <div className="contenedor-detalle ">
                    <div className="row">
                        <div className="col-12 cuadro1">
                            ...
                            <p className='NombreTipos'> {`Type: `}
                                <span className='type-item' style={{ background: 'red' }}>{pokemonActivo.types[0].type.name}</span>
                                {
                                    pokemonActivo.types.length>1 &&    <span className='type-item' style={{ background: obtenerClase(pokemonActivo?.types[1]?.type.name) }}>{pokemonActivo?.types[1]?.type.name}</span>
                    ...
                    <div className="row">
                        ...
                        <div className=" col-sm-12 col-lg-6 contenedor-general-status">
                            <div className="row ">
                                ...
                                <hr className='col-8 divisor' />
                                <div className="row fila-peso">
                                    <div className="col-12 col-sm-8 contenedor-peso">
