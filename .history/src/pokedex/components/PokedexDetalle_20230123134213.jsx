...
export const PokedexDetalle = () => {
    ...
    const [pokemonActivoSeteado,pokemonActivoSeteadoSet]=useState({...pokemonActivo})
    ...
    useEffect(() => {
        nombre=pokemonActivo.name
        nombre=nombre.toUpperCase();
        pokemonActivoSeteadoSet({...pokemonActivo,name:})
    }, [pokemonActivo])
