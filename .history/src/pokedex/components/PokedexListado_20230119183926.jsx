...
export const PokedexListado = () => {
    ...
    const { paginaActual,paginaAnterior } = useSelector((state) => state.ui)
    ...
    useEffect(() => {
        ...
        const funcion = async () => {
            await getObtenerImagenes(vectorPokemones, paginaActual * 1, paginaAnterior * 1)
