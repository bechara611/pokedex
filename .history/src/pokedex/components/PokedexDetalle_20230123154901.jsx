            ...
            {pokemonActivo?.sprites?.back_default ?
                ...
                <div className="contenedor-detalle ">
                    ...
                    <div className="row">
                        ...
                        <CardPoke className='izquierda' type={'Back'}sprite={pokemonActivo?.sprites?.back_default}></CardPoke>
                        <CardPoke className='izquierda' type={'Back'} sprite={pokemonActivo?.sprites?.back_shiny}></CardPoke>
                        </div>
                    </div>
