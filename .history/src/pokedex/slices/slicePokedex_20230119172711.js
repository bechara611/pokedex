...
export const { setPokemonActivo, settotalActual, setvectorPokemones, setvectorPokemonesCompleto, setBusquedaPokemon, setvectorPokemones2 } = slicePokedex.actions
