            ...
            <div className="container-fluid ">
                <div className="contenedor">
                    <div className="row fila">
                        <img src={charmander} className='iconos animate__animated animate__lightSpeedInLeft' alt="" />
                        <img src={pikachu} className='iconos animate__animated animate__lightSpeedInLeft' alt="" />
                    </div>
                    ...
                    <div className="row fila">
                        <img src={psyduck} className='iconos animate__animated animate__lightSpeedInRight' alt="" />
                        <img src={zubat} className='iconos animate__animated animate__lightSpeedInRight' alt="" />
                    </div>
                </div>
            </div>
        </>
