        ...
        <>
            ...
            <div className="contenedor">
                <div className="row fila">
                    <img src={charmander} className='pokeball' alt="" />
                    <img src={pikachu} className='pokeball' alt="" />
                </div>
                <div className="centro col-12"></div>
                <div className="row fila">
                <img src={psyduck} className='pokeball' alt="" />
                <img src={zubat} className='pokeball' alt="" />
                </div>
                </div>
            </div>
        </>
